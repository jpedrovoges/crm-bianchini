        ...
        {role === 'admin' && (
          <>
            ...
            <Link href="/dashboard/admin/configuracoes"
              className={`nav-link ${pathname === '/dashboard/admin/configuracoes' ? 'nav-link-active' : ''}`}>
              <span className={pathname === '/dashboard/admin/configuracoes' ? 'nav-icon-active' : 'nav-icon'}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
